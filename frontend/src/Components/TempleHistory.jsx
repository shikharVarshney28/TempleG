...
const TempleHistory = () => {
  ...
  const keyFeatures = [
    ...
    { num: "5", title: "मुख्य मंदिर", text: "गर्भगृह में ब्लू ग्रेनाइट की श्री महागणपति भगवान की चार फीट ऊँचे भव्य प्रतिमा स्थापित है। चबूतरे पर परिक्रमा मार्ग का निर्माण किया गया है और रात की रंग-बिरंगी लाइटें मुख्य आकर्षण हैं।" },
    ...
    { num: "10", title: "गउशाला", text: "मंदिर परिसर में स्थापित गौशाला में पालित उच्च नस्ल की गिर व साहिवाल गायों का दुग्ध नित्यअभिषेक, धार्मिक-अनुष्ठान व भोग प्रसाद के उपयोग में लाया जाता है।" }
  ];

  return (
    <section className="bg-[#fffcf9] py-24 px-4 md:px-6 relative overflow-hidden font-sans">
      
      {/* --- DIVINE BACKGROUND ELEMENTS (OM & SWASTIKA WATERMARKS) --- */}
      {/* टॉप राइट में दिव्य ॐ */}
      <div className="absolute -top-12 -right-12 pointer-events-none select-none text-orange-600/5 font-black text-[18rem] md:text-[26rem] leading-none">
        ॐ
      </div>

      {/* बॉटम लेफ्ट में पावन स्वस्तिक (SVG) */}
      <div className="absolute -bottom-16 -left-16 pointer-events-none select-none text-orange-600/5 w-72 h-72 md:w-[28rem] md:h-[28rem]">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" className="w-full h-full">
          <path d="M12 2v20M2 12h20M12 2h8v6M12 22H4v-6M2 12V4h6M22 12v8h-6" />
          {/* चार दिव्य बिंदु (चार पुरुषार्थ और दिशाओं के प्रतीक) */}
      ...
      <div className="max-w-7xl mx-auto space-y-24 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end border-b border-orange-100 pb-10 gap-8">
          <div className="max-w-3xl space-y-2">
            ...
            <h2 className="text-4xl md:text-6xl font-black text-red-950 tracking-tight leading-none">
