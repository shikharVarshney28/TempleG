...
const DailyDarshan = () => {
  // बदलाव: अब ग्लोबल कॉन्टेक्स्ट से सीधे 'darshan' और 'loading' निकाल रहे हैं
  const { darshan, loading } = useData();
  ...
  // यदि सॅनिटी में कोई दर्शन डेटा मौजूद नहीं है तो सुरक्षित रूप से रुकें
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20 relative">
          ...
          <h2 className="text-5xl md:text-5xl font-serif font-black text-red-900 tracking-tight leading-none mb-6">
            दैनिक <span className="text-orange-600 italic">दर्शन</span>
          </h2>
          ...
          <div className="inline-flex items-center gap-3 bg-white px-8 py-3 rounded-full shadow-lg border border-orange-100">
            ...
            <span className="text-gray-800 font-bold tracking-widest uppercase text-sm">
              {/* बदलाव: darshan.date का उपयोग किया गया है */}
              {darshan.date && new Date(darshan.date).toLocaleDateString('hi-IN', {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          {/* बदलाव: darshan.deities का उपयोग किया गया है */}
          {darshan.deities?.map((item, index) => (
            <div key={index} className="flex flex-col group">
              ...
              <div className="relative overflow-hidden rounded-[2rem] shadow-2xl bg-black aspect-[3/4.5] border-[12px] border-white ring-1 ring-orange-100">
                ...
                <img
                  src={urlFor(item.image).width(600).format('webp').url()}
                  alt={item.deityName}
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8">
                  <p className="text-orange-400 font-black text-[10px] tracking-[0.4em] uppercase mb-2">दिव्य स्वरूप</p>
